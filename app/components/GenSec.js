        ...
        <div className="gen-sec-letter-container shadow relative">
          <section className="gen-sec-letter flex flex-col md:flex-row items-start justify-between">
            <div className="text-left w-full md:w-1/2 pr-4 mb-4 md:mb-0">
              ...
              <h2 className="text-2xl text-right font-bold right-0 bottom-5 mb-4">Yours Truly,</h2>
              <h3 className="text-right font-bold right-0 bottom-3 mb-4">Kushal</h3>
            </div>
            ...
            <div className="w-full md:w-1/2 relative flex justify-center md:justify-end mt-4 md:mt-0">
              <img
                ...
                className="w-3/4 h-auto md:w-1/2 md:h-auto md:absolute md:top-40 md:right-40"
              />
            </div>
          </section>
        </div>
